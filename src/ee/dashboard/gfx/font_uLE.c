//---------------------------------------------------------------------------
// File name:    font_uLE.c  //Holds font_uLE (default font)
//---------------------------------------------------------------------------
// Font glyph data reused verbatim from wLaunchELF (formerly uLaunchELF),
// https://github.com/ps2homebrew/wLaunchELF, licensed under the Academic
// Free License v2.0 (same license as PS2SDK itself). Per AFL 2.0's
// attribution requirement: this file is unmodified from the upstream
// source except for removing the unused `FontBuffer` global (this
// project decodes glyphs directly into a GS texture atlas instead - see
// bitmap_font.c - rather than copying into an intermediate buffer the
// way wLaunchELF's own renderer does).
// clang-format off
